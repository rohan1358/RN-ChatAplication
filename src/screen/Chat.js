...
export default class MChats extends React.Component {
  static navigationOptions = ({navigation}) => {
    return {
      title: this.props.navigation.getParam('username', null),
  ...
  constructor(props) {
    ...
    this.state = {
      // person: {
      //   name: props.navigation.params('username'),
      //   Pin: props.navigation.getParam('Pin'),
      // },
      textMessage: '',
      messageList: [],
  ...
  componentDidMount() {
    ...
    this.state.dbRef
      .child(User.phone)
      .child(this.props.navigation.params('Pin'))
  ...
  sendMessage = async () => {
    if (this.state.textMessage.length > 0) {
      ...
      updates[User.phone + '/' + this.state.person.Pin + '/' + msgId] = message;
      updates[this.state.person.Pin + '/' + User.phone + '/' + msgId] = message;
